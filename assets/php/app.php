...
<body>
    <div class="site">
            ...
            <div id="popup" class="popup">
                ...
                <div class="formulario" id="idFormulario">
                    <form action="./assets/php/app.php" method="POST">
                        ...
                        <div class="rodape">
                            <div>
                                <button class="botao" type="submit" id="adicionar-dados"
        ...
        <dialog id="dialogPopupNotas">
            <div id="popupNotas" class="popupNotas">
                <div class="Cadastro">
        ...
        <div class="container-popup"> 
            <dialog id="popupTabela" class="popupTabela">
                <div class="Cadastro">
                        ...
                        <div class="notasBimestreEditar">
                            <div class="divNotasEditar">
                                <div>
                                    ...
                                    <input class="NotasEditar" type="number" id="input_prova_1" name="Prova 1 " max="10.0"
                                        min="0" step="0.1">
                                </div>
                                <div>
                                    <span class="spanNotasEditar" for="input_ra">AEP 1:</span>
                                    <input class="NotasEditar" type="number" id="input_aep_1" name="AEP" max="10.0" min="0"
                                        step="0.1">
                                </div>
                                <div>
                            ...
                            <div class="divNotasEditar">
                                <div>
                                    ...
                                    <input class="NotasEditar" type="number" id="input_prova_2" name="Prova 2 " max="10.0"
                                        min="0" step="0.1">
                                </div>
                                <div>
                                    <span class="spanNotasEditar" for="input_ra">AEP 2:</span>
                                    <input class="NotasEditar" type="number" id="input_aep_2" name="AEP" max="10.0" min="0"
                                        step="0.1">
                                </div>
                                <div>
        ...
        <div class="botoesControle">
            ...
            <button id="openSalvar" class="botaoSalvar">ver função</button>
        ...
        <div class="fora-wrapper">
            <div class="tabela-wrapper">
                <table id="idTabela" class="tabela">
                    ...
                    <tbody>
                        <?php foreach($listaF as $listaAlunos): ?>
                        <tr>
                            <td><?=$listaAlunos['Nome'];?></td>
                            <td><?=$listaAlunos['RA'];?></td>
                            <td><?=$listaAlunos['Email'];?></td>
                            <td><?=$listaAlunos['Prova1'];?></td>
                            <td><?=$listaAlunos['AEP1'];?></td>
                            <td><?=$listaAlunos['ProvaIntegrada1'];?></td>
                            <td><?=$listaAlunos['Media1B'];?></td>
                            <td><?=$listaAlunos['Prova2'];?></td>
                            <td><?=$listaAlunos['AEP2'];?></td>
                            <td><?=$listaAlunos['ProvaIntegrada2'];?></td>
                            <td><?=$listaAlunos['Media2B'];?></td>
                            <td><?=$listaAlunos['MediaFinal'];?></td>
                            <td><?=$listaAlunos['Situacao'];?></td>
                            <td class="actions">
                    ...
                    <tfoot>
                        <tr id="idMediasTabela">
                            ...
                            <th>MEDIAS</th>
                            <th id="mediaProva1">-</th>
                            <th id="mediaAEP1">-</th>
                            <th id="mediaProvaIntegrada1">-</th>
                            <th id="media1Bi">-</th>
                            <th id="mediaProva2">-</th>
                            <th id="mediaAEP2">-</th>
                            <th id="mediaProvaIntegrada2">-</th>
                            <th id="media2Bi">-</th>
                            <th id="mediaGeral">-</th>
                            <th>
                                <h1></h1>
