        ...
        <dialog id="dialogPopupEditarNotas">
            <div id="popupTabela" class="popupTabela">
                ...
                <div class="formulario" id="idFormulario">
                    <form>
                        <div class="placeholder">
                            <input type="text" id="input_nomeEditar" name="nome">
                            <span for="nome">Nome:</span>
                        </div>
                        <div class="placeholder">
                            <input type="number" id="input_raEditar" name="ra">
                            <span for="input_ra">RA:</span>
                        </div>
                        <div class="placeholder">
                            <input type="email" id="input_emailEditar" name="email">
                            <span for="input_email">Email:</span>
                        </div>
                        <div class="notasBimestreEditar">
                            <div class="divNotasEditar">
                                <div>
                                    ...
                                    <input class="NotasEditar" type="number" id="input_prova_1Editar" name="Prova 1 "
                                        max="10.0" min="0" step="0.1">
                                </div>
                                <div>
                                    <span class="spanNotasEditar" for="input_ra">AEP 1:</span>
                                    <input class="NotasEditar" type="number" id="input_aep_1Editar" name="AEP" max="10.0"
                                        min="0" step="0.1">
                                </div>
                                <div>
                                    <span class="spanNotasEditar" for="input_email">Prova Integrada 1 :</span>
                                    <input class="NotasEditar" type="number" id="input_prova_integrada_1Editar"
                            ...
                            <div class="divNotasEditar">
                                <div>
                                    ...
                                    <input class="NotasEditar" type="number" id="input_prova_2Editar" name="Prova 2 "
                                        max="10.0" min="0" step="0.1">
                                </div>
                                <div>
                                    <span class="spanNotasEditar" for="input_ra">AEP 2:</span>
                                    <input class="NotasEditar" type="number" id="input_aep_2Editar" name="AEP" max="10.0"
                                        min="0" step="0.1">
                                </div>
                                <div>
                                    <span class="spanNotasEditar" for="input_email">Prova Integrada 2:</span>
                                    <input class="NotasEditar" type="number" id="input_prova_integrada_2Editar"
                        ...
                        <div class="rodape">
                            ...
                            <div>
                                <button class="botao" type="button" id="cancelar" onclick="FecharPopup()" >Cancelar</button>
                            </div>
                        </div>
                    </form>
                </div>
